...
// Sidebar
	...
	const tabLinks = document.querySelectorAll('.user-tabs a');
...
tabLinks.forEach((link) => {
  link.addEventListener('click', (e) => {
    ...
    // Add active class to clicked tab link and content
    const selectedTab = e.target.getAttribute('href').substring(1);
