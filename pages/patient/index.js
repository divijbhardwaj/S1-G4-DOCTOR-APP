    ...
    <>
      ...
      <header class="leading-[3rem]">
        ...
        <div class="flex flex-col h-screen">
            <nav class="bg-blue-500 text-gray-200 px-4 py-2">
                <h1 class="text-lg font-bold">Patient Dashboard</h1>
                <ul class="flex">
                <li class="mr-4"><a href="#">Appointments</a></li>
                <li class="mr-4"><a href="#">Medications</a></li>
                <li class="mr-4"><a href="#">Test Results</a></li>
                <li class="mr-4"><a href="#">Health Records</a></li>
                </ul>
            </nav>
