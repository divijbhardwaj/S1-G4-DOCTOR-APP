    ...
    <header className="leading-[3rem]">
        <nav className="bg-white  BG-PO border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
            <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <img src="images/logo.jfif" class="img-fluid" width="30"/>
      ...
      <footer className="footer">
                ...
                <div className="footer-widget footer-about">
                    ...
                    <div className="footer-about-content">
                      <h1 className="text-white font-bold mb-2"><img src="images/logo.jfif" class="img-fluid" width="50"/></h1>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-white sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com" target="_blank" className="hover:underline">DocApp</a>. All Rights Reserved.
    </span>
