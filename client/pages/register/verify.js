  ...
  return (
    <>
      ...
      <div class="max-w-xl px-5 text-center">
        ...
        <p class="mb-2 text-lg text-zinc-500">We are glad, that you’re with us ? We’ve sent you a verification link to the email address <span class="font-medium text-indigo-500">{email}</span>.</p>
