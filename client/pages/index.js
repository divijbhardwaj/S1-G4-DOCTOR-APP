      ...
      <header className="leading-[3rem]">
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <a href="https://doctor app.com" className="flex items-center">
                        <img src="/assets/img/logo.png" className="mr-3 h-6 sm:h-9" alt="doctor app Logo" />
        ...
        <div className="relative">
            <img
              ...
              alt="Image alt text"
            />
            <h3 className="absolute text-4xl  top-10 left-20 py-10">Experience quality healthcare services
           
            <p className="absolute text-xl text-gray-500 py-10">Our team of skilled medical professionals is dedicated to providing
            ...
            <a className="absolute px-4 py-2 text-white no-underline bg-blue-500 rounded hover:bg-blue-600 text-2xl bottom-10 left-20">Book Now</a>
            </div>        
  ...
  <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="bg-white shadow-md rounded-lg px-8 py-10">
        <h3 className="text-xl font-bold text-gray-900 mb-2">Virtual Consultation</h3>
        <p className="text-gray-700 text-base mb-4">If you prefer to meet with one of our healthcare providers from the comfort of your own home, a virtual consultation may be the right choice for you.</p>
        <p className="text-gray-700 text-base mb-4">To schedule a virtual consultation, please call us at:</p>
        <p className="text-gray-700 font-bold text-lg">(+1) 123-4567</p>
        <p className="text-gray-700 text-base mb-4">We'll be happy to help you set up a convenient time for your appointment.</p>
        <a className=" px-4 py-2 text-white no-underline bg-blue-500 rounded hover:bg-blue-600 text-2xl bottom-10 left-20">Book Now</a>
      ...
      <div className="bg-white shadow-md rounded-lg px-8 py-10">
        ...
        <p className="text-gray-700 text-base mt-4">If you have any questions or would like to schedule an appointment over the phone, please call us at:</p>
        <p className="text-gray-700 font-bold text-lg">(+1) 123-4567</p>
      </div>
    </div>
  </div>
        ...
        <section className="bg-white dark:bg-gray-900 px-10">
          ...
          <div className="px-10 mx-auto bg-blue-500 text-white">
          ...
          <footer className="bg-blue py-8">
              <div className="container mx-auto flex flex-wrap">
                ...
                <div className="w-full md:w-1/4 px-4">
                  ...
                  <ul className="list-none">
                    <li><span className="tex-white">Monday - Friday:</span> 8am to 7pm</li>
                    <li><span className="tex-white">Saturday - Sunday:</span> Closed</li>
                    <li><span className="tex-white">Public Holidays:</span> Closed</li>
                  </ul>
                </div>
                <div className="w-full md:w-1/4 px-2">
                  <h3 className="text-white font-bold mb-2">Quick Links</h3>
                  <ul className="list-none">
                    <li><a href="#" className="tex-white hover:text-white">About Us</a></li>
                    <li><a href="#" className="tex-white hover:text-white">Services</a></li>
                    <li><a href="#" className="tex-white hover:text-white">Doctors</a></li>
                    <li><a href="#" className="tex-white hover:text-white">Contact</a></li>
                  </ul>
                </div>
                <div className="w-full md:w-1/4  px-4">
              ...
              <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-white sm:text-center dark:text-gray-400">© 2022 <a href="https://doctor app.com" target="_blank" className="hover:underline">DocApp</a>. All Rights Reserved.
          </span>
